...
function get_student_url(array $student_id): string// trying to pass instructor id so I can
//make a back button that only advisor can see
{
    ...
    <div style="display: flex; flex-direction: column; gap: 1rem;">
      ...
      <table style="width: 100%;">
        ...
        <tr>
          ...
          <td>
            <a
              href="<?= get_student_url($advisee['student_id']) ?>">
